...
public class ChooseClassScreen implements Screen{
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_ENTER:
			if(check == 0) {
				return new ChooseAbilityScreen("Warrior", playerSpecies);
			}else if(check == 1) {
				return new ChooseAbilityScreen("Barbarian", playerSpecies);
			}else if(check == 2) {
				return new ChooseAbilityScreen("Evoker", playerSpecies);
			}else if(check == 3) {
				return new ChooseAbilityScreen("Rogue", playerSpecies);
			}else if(check == 4) {
				return new ChooseAbilityScreen("Ranger", playerSpecies);
			}else if(check == 5) {
				return new ChooseAbilityScreen("Alchemist", playerSpecies);
			}else if(check == 6) {
				return new ChooseAbilityScreen("Wizard", playerSpecies);
			}else if(check == 7) {
				return new ChooseAbilityScreen("Witch", playerSpecies);
			}else if(check == 8) {
				return new ChooseAbilityScreen("Sorcerer", playerSpecies);
			}
		case KeyEvent.VK_ESCAPE: return new ChooseSpeciesScreen();
		}
