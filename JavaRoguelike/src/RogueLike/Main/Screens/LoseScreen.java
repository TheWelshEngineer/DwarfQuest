...
public class LoseScreen implements Screen {
    ...
    public void displayOutput(AsciiPanel terminal) {
		...
		terminal.writeCenter(String.format("Level %d %s %s | Score: %d | Max Depth Reached: %d", player.level(), player.playerSpecies(), player.playerClass(), player.score(), player.maxDepth()+1), 9);
