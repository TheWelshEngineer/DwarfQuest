...
public class StatsScreen implements Screen{
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		y++;
		terminal.writeCenter(String.format("Level %d %s %s", player.level(), player.playerSpecies(), player.playerClass()), y++);
        ...
        terminal.writeCenter("-- [LEFT / RIGHT]: Skills | [ESCAPE]: Return to Game --", 38);
